...
interface WaiterOnOrderAddProductPageProps {}

const WaiterOnOrderAddProductPage: React.FC<
	WaiterOnOrderAddProductPageProps
> = () => {
...
export default WaiterOnOrderAddProductPage;
